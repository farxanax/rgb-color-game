...
/* attempt to make all the square have background color: rgb (200,45,255)
 you would attach an eventlistener to the start button*/ 

const startButton = document.getElementById("reset");
startButton.addEventListener("click", function () {
this.innerHTML = "New Colors";

    // assign each individual square background color
    ...
    // assign a Header a random rgb value from one of the square values.
...
/* add even listener to square so that it either 
disappears or changes every square's color */
